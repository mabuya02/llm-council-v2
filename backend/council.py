...
async def stage3_synthesize_final(
    ...
    if response is None:
        # Final fallback if synthesis fails
        fallback_text = (
            stage1_results[0]["response"]
            if stage1_results and stage1_results[0].get("response")
            else "Unable to generate final synthesis."
        )
        return {
...
Title:"""
    ...
    # Use an Ollama model for title generation
